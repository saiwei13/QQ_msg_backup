...
function test(){
    ...
    var salt = '\x00\x00\x00\x00\x7c\x0f\x3f\xf3'
    $.Encryption.getEncryption('6377508',salt,'ssss')

    console.log('test()')

    var md5Pwd = $.Encryption.md5('gguuss')
    var h1 = $.Encryption.hexchar2bin(md5Pwd)

    var s2 = $.Encryption.md5(h1 + salt)
